...
type MessageEvent struct {
	...
	EventAt        *timestamp.Timestamp   `protobuf:"bytes,4,opt,name=event_at,json=eventAt,proto3" json:"event_at,omitempty"` // timestamp of the event
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MessageEvent) GetEventAt() *timestamp.Timestamp {
	if x != nil {
		return x.EventAt
	}
	return nil
...
const file_proto_razpravljalnica_proto_rawDesc = "" +
	...
	"\fControlPlane\x12S\n" +
	"\x0fGetClusterState\x12\x16.google.protobuf.Empty\x1a(.razpravljalnica.GetClusterStateResponseB&Z$github.com/jeraj/razpravljalnica/genb\x06proto3"
